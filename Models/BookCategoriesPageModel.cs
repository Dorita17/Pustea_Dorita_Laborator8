...
namespace Pustea_Dorita_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pustea_Dorita_Lab8Context context,  Book book)
        {
        ...
        public void UpdateBookCategories(Pustea_Dorita_Lab8Context context,
